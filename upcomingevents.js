...
function filtrarArray(){
    ...
    //     document.querySelector('#cartasUpcoming').innerHTML = newTemplate
    // }
...
function displayCardEvents(datas){ //imprime las cartas 
    var templateHtml = ""
...
if(templateHtml.length > 0){
    document.querySelector('#cartasUpcoming').innerHTML = templateHtml
}
else { 
